...
class IncidenciasPatrullajePaginated {
  final int total;
  final int page;
  final int limit;
  ...
  /*
   * Aunque el backend utiliza la propiedad "data",
   * en Flutter la exponemos como "items".
   */
  final List<IncidenciaDetalleData> items;

  const IncidenciasPatrullajePaginated({
    required this.total,
    required this.page,
    required this.limit,
  ...
  factory IncidenciasPatrullajePaginated.fromJson(Map<String, dynamic> json) {
    final rawItems = json['data'];

    return IncidenciasPatrullajePaginated(
