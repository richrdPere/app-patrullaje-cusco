...
class IncidenciasPatrullajeQueryParams {
  final int page;
  final int limit;
  ...
  const IncidenciasPatrullajeQueryParams({
    this.page = 1,
    this.limit = 10,
  ...
  IncidenciasPatrullajeQueryParams copyWith({
    int? page,
    int? limit,
    ...
    return IncidenciasPatrullajeQueryParams(
      page: page ?? this.page,
